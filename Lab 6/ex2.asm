...
main:
  ...
  add	$8, $0, $v0			# copy the width into $8
				...
				# Check if width equals 0
  beq $8, $0, exit			# jumps to exit is it does (terminates)
  ...
  mflo	$10				# bring the product into $10 (assume hi not needed)
  				...
  				# Calculate perimeter
  add	$11, $8, $8			# double the width, store in $11
  add	$12, $9, $9			# double the height, store in $12
  add	$13, $11, $12			# add the width and height, store in $13
  ...
  syscall           			# print the integer (area)
  ...
  syscall				# print the integer (perimeter)
  ...
  syscall           			# print the string
  				...
  				# Jumps back to main
  j	main				# Loops until width equals 0
