...
strings:      	.space		10000
prompt1:	.asciiz		"Enter the number of strings you want to sort: "
prompt2:	.asciiz		"Here are the strings in alphabetical order: "
newline:	.asciiz		"\n"
...
main:
  ...
  la 		$a0, prompt1 		# address of newline string is in $a0
...
printPrompt:
  ...
  addi 		$v0, $0, 4  		# system call 4 is for printing a string
  la 		$a0, prompt2 		# address of newline string is in $a0
  syscall           			# print the string  
